...
class unconnectedMap extends Component {
  ...
  clickHandler = (event, viewport) => {
    ...
    this.setState({
      ...
      popuplng: this.state.popup.longitude.concat({ longitude: lng }),
      popuplat: this.state.popup.latitude.concat({ latitude: lat }),
        ...
        >
          ...
          {this.state.showPopup ? (
            <Popup
              ...
              longitude={this.state.popuplng[0].longtidute}
              closeButton={true}
              closeOnClick={false}
              onClose={() =>
