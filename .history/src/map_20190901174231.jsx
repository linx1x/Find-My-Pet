...
class unconnectedMap extends Component {
  ...
  let testl: this.state.markers.longitude.concat(this.state.popup.longitude)
  ...
  handleSubmit = event => {
    event.preventDefault();
    let newMarker = {
      latitude: this.state.markers.latitude.concat(this.state.popup.latitude),
      longitude: this.state.markers.longitude.concat(this.state.popup.longitude)
    };
