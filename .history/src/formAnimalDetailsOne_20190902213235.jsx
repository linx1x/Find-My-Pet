  ...
  render() {
    ...
    return (
      <MuiThemeProvider>
        ...
        >
            <FormControlLabel value="cat" control={<Radio />} label="cat"  onChange={handleChange("animalType")}  />
            <FormControlLabel value="dog" control={<Radio />} label="dog"  onChange={handleChange("animalType")} />
            </RadioGroup>
          </div>
