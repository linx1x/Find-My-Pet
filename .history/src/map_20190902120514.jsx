...
class unconnectedMap extends Component {
  ...
  handleSubmit = event => {
    event.preventDefault();
    let testlat = this.state.markers.latitude[0];
    let testlng = this.state.markers.longitude[1];
      ...
      <div className="MainDiv">
        ...
        >
          ...
          {this.state.displayMarker ? (
            ...
            <Marker
              latitude={this.state.markers.latitude[0]}
              longitude={this.state.markers.longitude[0]}
            >
