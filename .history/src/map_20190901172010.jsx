...
class unconnectedMap extends Component {
  ...
  handleSubmit = event => {
    ...
    this.setState({ marker: marker.concat(newMarker) });
   ...
   let mapMarkerlat = for ()this.state.makers.latitude
   let mapMarkerlng = this.state.markers.longitude
  render() {
      ...
      <div className="MainDiv">
        ...
        >
          ...
          {this.state.displayMarker ? (
            ...
            <Marker
              latitude={this.state.markers.latitude.map()}
              longitude={this.state.markers.longitude.map()}
            >
